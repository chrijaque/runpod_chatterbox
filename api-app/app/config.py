...
class Settings:
    ...
    VC_TURBO_ENDPOINT_ID: str = os.getenv("VC_TURBO_ENDPOINT_ID", "")
    TTS_TURBO_ENDPOINT_ID: str = os.getenv("TTS_TURBO_ENDPOINT_ID", "")
    VC_MTL_ENDPOINT_ID: str = os.getenv("VC_MTL_ENDPOINT_ID", "")
    TTS_MTL_ENDPOINT_ID: str = os.getenv("TTS_MTL_ENDPOINT_ID", "")
...
logger.info(f"📋 VC_TURBO_ENDPOINT_ID: {settings.VC_TURBO_ENDPOINT_ID}")
logger.info(f"📋 TTS_TURBO_ENDPOINT_ID: {settings.TTS_TURBO_ENDPOINT_ID}")
logger.info(f"📋 VC_MTL_ENDPOINT_ID: {settings.VC_MTL_ENDPOINT_ID}")
logger.info(f"📋 TTS_MTL_ENDPOINT_ID: {settings.TTS_MTL_ENDPOINT_ID}")
